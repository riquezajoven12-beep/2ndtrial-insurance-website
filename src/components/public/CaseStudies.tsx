  ...
  const cases = [
    {
      ...
      outcome: 'RM38,000 hospitalisation claim — approved and paid, subject to policy terms',
    },
    {
      ...
      outcome: 'RM200,000 critical illness payout — processed per policy terms and assessment',
    },
    {
      ...
      outcome: 'RM2,500/month guaranteed retirement income as per policy contract',
    },
  ];
