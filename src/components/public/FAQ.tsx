...
const faqs = [
  ...
  { q: 'Are insurance premiums tax-deductible in Malaysia?', a: 'Yes. Life insurance premium relief up to RM3,000 and medical/education insurance relief up to RM3,000 annually under LHDN guidelines.' },
  ...
  { q: 'How do I get started?', a: 'Simply fill in the free assessment form below, or contact us via WhatsApp. We will review your situation and provide a no-obligation recommendation within 24 hours.' },
];
