      ...
      <div className="max-w-[1200px] mx-auto px-6 relative z-10">
        <div className="max-w-[720px]">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-[3.4rem] text-white mb-5 font-normal leading-tight">
            The right medical, life, and retirement cover — <em className="text-gold-light">planned around your family</em>, not around sales targets.
          </h1>
          <p className="text-lg text-white/75 mb-9 max-w-[560px] leading-relaxed">
            Licensed Great Eastern advisor helping Malaysian families understand, choose, and claim their insurance — with clear guidance at every step.
          </p>
          <div className="flex gap-3 flex-wrap mb-12">
            <a href="#contact" className="btn-primary">Get My Free Coverage Review →</a>
            <a href="#calculator" className="btn-secondary">📊 Use Coverage Calculator</a>
          </div>
