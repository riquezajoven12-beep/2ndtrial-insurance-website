    ...
    <section id="contact" className="py-20 bg-gradient-to-br from-deep to-navy text-white">
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="text-center">
          ...
          <h2 className="text-3xl md:text-4xl text-white mb-4">Get Your Free Coverage Review</h2>
        ...
        <div className="bg-white/5 border border-white/10 rounded-xl p-12 max-w-[680px] mx-auto">
          ...
          {success ? (
            <div className="text-center py-6">
              ...
              <p className="text-white/60 text-sm">We&apos;ll review your details and reach out, usually within business hours.</p>
            </div>
          ) : (
            <form onSubmit={submit}>
              ...
              {step === 3 && (
                <div>
                  ...
                  <p className="text-center text-white/50 text-sm mb-7">We&apos;ll usually respond within business hours</p>
                  ...
                  <div className="flex justify-between mt-6">
                    ...
                    <button type="submit" disabled={submitting} className="btn-primary">
                      {submitting ? 'Submitting...' : 'Get My Free Coverage Review →'}
                    </button>
                  </div>
                </div>
              )}
