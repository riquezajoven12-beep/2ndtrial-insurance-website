          ...
          <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-6">
            <div className="bg-white rounded-xl w-full max-w-lg max-h-[90vh] overflow-y-auto shadow-2xl">
              <div className="p-8 border-b">
                ...
                <p className="text-sm text-gray-400">A licensed advisor will contact you within 24 hours</p>
              </div>
          ...
          <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-6">
            <div className="bg-white rounded-xl p-12 text-center max-w-md shadow-2xl">
              ...
              <p className="text-sm text-gray-500 mb-6 leading-relaxed">
                A licensed advisor will review your selected plans and contact you within 24 hours with a personalised recommendation.
              </p>
