...
('Priya D.', 'Teacher, Selangor', '38', 'Medical + Education Plan', 'Tharmanathan took the time to understand my family''s actual needs instead of pushing the most expensive plan. His annual reviews ensure we''re always properly covered.', 'PD', 1),
('Raj K.', 'Engineer, KL', '45', 'Family Medical Plan', 'When my father was hospitalised unexpectedly, the claim was processed smoothly. Having a dedicated advisor who handled everything made a stressful time much easier.', 'RK', 2),
('Siti L.', 'Business Owner, PJ', '52', 'Keyman + Life Plan', 'As a business owner, I needed keyman insurance and proper succession planning. Tharmanathan structured everything clearly and helped me understand exactly what I was getting.', 'SL', 3);
